...
def create_test_dataset() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {
            "transcription": "Здравствуйте, мне нужно к терапевту. У меня болит живот. Можно сегодня в 18 часов?",
            "reference_data": {
                "corrected_transcription": "Здравствуйте, мне нужно к терапевту. У меня болит живот. Можно сегодня в 18:00?",
